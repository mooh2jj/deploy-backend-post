    ...
    CommandLineRunner init() {
        return (args) -> {
            ...
            List<Post> posts = List.of(
                    Post.of(PostRequest.of("SpringBoot 스터디", "Spring Boot 프레임워크의 핵심 기능을 배우는 스터디입니다. 의존성 주입, JPA, REST API 개발 등 실무에서 필요한 기술을 중점적으로 다룹니다. 매주 화요일 저녁 7시에 모임이 있으며, 과제와 미니 프로젝트를 통해 실력을 향상시킵니다.")),
                    Post.of(PostRequest.of("AWS 인프라&배포 스터디", "AWS 클라우드 환경에서의 인프라 구축과 애플리케이션 배포에 관한 스터디입니다. EC2, S3, RDS, Lambda 등의 서비스를 학습하고 CI/CD 파이프라인 구축 방법을 실습합니다. 클라우드 아키텍처 설계부터 실제 배포까지 전 과정을 경험할 수 있습니다.")),
